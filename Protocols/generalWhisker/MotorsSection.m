...
switch action
    ...
    case 'init',   % ------------ CASE INIT ----------------
        ...
        tabledata = mltable(gcf, value(tbl), 'CreateTable', columninfo, rowHeight, cell_data, gFont);
        
        %make this a soloParamHandle
        SoloParamHandle(obj,'tabledata','value',tabledata);
        
        %set table callbacks
        mltable(gcf, value(tbl), 'Action','SetDblClick'); %double click function
    ...
    case 'move_next_side', % --------- CASE MOVE_NEXT_SIDE -----
        ...
        tabledata.value=mltable(value(motorfig), value(tbl), 'UpdateCellSelection',[],[],[],[],posRow);
    ...
    case 'face_poly_def'
        ...
        %destreoy old table
        mltable(gcf, value(tbl), 'DestroyTable');
        %create new table
